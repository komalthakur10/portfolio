  ...
  return (
    <div className="mx-4 lg:mx-10 py-12 ">
      ...
      >
        ...
        >
          <div className="flex flex-wrap  p-4 lg:p-0 lg:justify-center">
        ...
        <a
          ...
          rel="noopener noreferrer"
        >
          <div className="flex flex-wrap  ps-7 lg:p-0 lg:justify-center">
        ...
        <a
          ...
          rel="noopener noreferrer"
        >
          <div className="flex flex-wrap ps-7 pt-4 lg:p-0 lg:justify-center">
